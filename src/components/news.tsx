      ...
      <header className="bg-gray-900 text-white">
        <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-xl">
            Stay updated with the latest news, industry insights, and company announcements from SecureGuard.
          </p>
        </div>
      </header>
          ...
          {filteredArticles.map((article) => (
            <div key={article.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <h2 className="text-xl font-bold mb-2 text-blue-600">{article.title}</h2>
                <p className="text-gray-600 mb-4 h-20 overflow-hidden">{article.excerpt}</p>
